  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <img
          src="/category-functional.jpg"
          alt="Athlete training with battle ropes"
          className="w-full h-full object-cover"
        />
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-t from-sage-dark/95 via-sage-dark/80 to-sage-dark/60" />
      </div>
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-cream/80 mb-10 max-w-xl mx-auto">
            Get your free 3-day pass and expert fitness tips delivered to your inbox.
          </p>
          ...
          <p className="text-cream/60 text-sm mt-6">
            Join 2,500+ members pushing their limits.
          </p>
        </div>
        ...
        >
          ...
          <div className="text-cream/80 text-sm">
            <span className="font-semibold text-cream">2,500+</span> members already joined
          </div>
        </div>
      </div>
    </section>
